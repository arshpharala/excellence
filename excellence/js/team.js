        ...
        <div class="flip-card-inner">
          ...
          <div class="flip-card-back">
            ...
            <ul class="social-links">
              <li><a href="https://linkedin.com/in/yourprofile" target="_blank" rel="noopener noreferrer"><img class="social-icon" src="/assets/socialIcon/linkedin.png" alt="${member.name}'s LinkedIn" /></a></li>
              <li><a href="https://facebook.com/yourprofile" target="_blank" rel="noopener noreferrer"><img class="social-icon" src="/assets/socialIcon/facebook.png" alt="${member.name}'s Facebook" /></a></li>
              <li><a href="https://twitter.com/yourprofile" target="_blank" rel="noopener noreferrer"><img class="social-icon" src="/assets/socialIcon/x.png" alt="${member.name}'s Twitter" /></a></li>
              <li><a href="https://instagram.com/yourprofile" target="_blank" rel="noopener noreferrer"><img class="social-icon" src="/assets/socialIcon/instagram.png" alt="${member.name}'s Instagram" /></a></li>
            </ul>
          </div>
        </div>
      </div>`;
